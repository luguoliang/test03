...
#import "BFAuthorizeViewController.h"
#import "BFProgressHUD.h"
@interface BFAuthorizeViewController ()<UIWebViewDelegate,UIAlertViewDelegate,NSURLConnectionDelegate,NSURLConnectionDataDelegate>
{
    UIWebView*_web;
...
@implementation BFAuthorizeViewController
...
#pragma mark
    ...
    switch (self.operState) {
        ...
        case 2:
        {
            [self loadHtml:@"https://pm.baofoo.com/custody/inAccredit.do"];
        }
            break;
