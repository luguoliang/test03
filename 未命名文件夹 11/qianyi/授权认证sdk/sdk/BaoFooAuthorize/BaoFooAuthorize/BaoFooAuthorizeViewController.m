...
@interface BaoFooAuthorizeViewController ()<UIWebViewDelegate,UIAlertViewDelegate,NSURLConnectionDelegate,NSURLConnectionDataDelegate>
{
    UIWebView*_web;
...
@implementation BaoFooAuthorizeViewController
